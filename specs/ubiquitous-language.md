...
| **Runtime Capability** | A node's ability to execute a specific artifact type (OCI, native, Wasm, K8s, MicroVm) | Not a workload property. The node advertises runtimes; the workload declares artifact type; the solver matches. |
