...
| **Revocation Grace Period** | Policy-configurable window after key revocation during which units signed near the boundary are handled | Not a delay. Acknowledges gossip convergence time. Governance tunes this per trust domain. |
