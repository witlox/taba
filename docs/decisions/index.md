...
ADRs document significant architectural decisions — the context,
the decision, and the consequences. They are append-only: supersede
old ADRs with new ones, don't edit.

| ID | Title | Status |
|----|-------|--------|
| [ADR-001](adr-001-unit-model.md) | Unit Model — four typed units | Accepted |
| [ADR-002](adr-002-crdt-graph.md) | CRDT Graph — δ-state, no consensus | Accepted |
