...
//! Common step definitions — no-ops for ALL steps.
//! Ambiguous matches with features.rs/smoke.rs/critical.rs
//! will cause cucumber to fail. Remove the conflicting
//! no-ops incrementally as features.rs expands.
