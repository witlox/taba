...
#[when("a bootstrapped trust domain \"acme\" (Tier 0, solo developer)")]
async fn step_1178(_w: &mut TabaWorld) {}

#[then("a bootstrapped trust domain \"acme\" (Tier 0, solo developer)")]
...
#[when("a bootstrapped trust domain \"acme\" with root governance unit")]
async fn step_1181(_w: &mut TabaWorld) {}

#[then("a bootstrapped trust domain \"acme\" with root governance unit")]
...
#[when("a bootstrapped trust domain \"acme-prod\" with root governance unit")]
async fn step_1184(_w: &mut TabaWorld) {}

#[then("a bootstrapped trust domain \"acme-prod\" with root governance unit")]
...
#[given(
    "alice authors a policy unit \"sneaky-policy\" resolving conflict between \"unit-x\" and \"unit-y\""
)]
...
#[when("alice authors a workload unit \"analytics-worker\" with:")]
async fn step_1583(_w: &mut TabaWorld) {}

#[then("alice authors a workload unit \"analytics-worker\" with:")]
...
#[when("alice authors a workload unit \"early-unit\" with:")]
async fn step_1586(_w: &mut TabaWorld) {}

#[then("alice authors a workload unit \"early-unit\" with:")]
...
#[when("alice authors a workload unit \"incomplete-unit\" with:")]
async fn step_1589(_w: &mut TabaWorld) {}

#[then("alice authors a workload unit \"incomplete-unit\" with:")]
async fn step_1590(_w: &mut TabaWorld) {}

#[given("alice authors a workload unit \"late-unit\" with:")]
async fn step_1591(_w: &mut TabaWorld) {}

#[when("alice authors a workload unit \"late-unit\" with:")]
async fn step_1592(_w: &mut TabaWorld) {}

#[then("alice authors a workload unit \"late-unit\" with:")]
...
#[when("alice authors a workload unit \"misbound-api\" with:")]
async fn step_1598(_w: &mut TabaWorld) {}

#[then("alice authors a workload unit \"misbound-api\" with:")]
...
#[given("alice authors a workload unit \"staging-api\" with:")]
async fn step_1606(_w: &mut TabaWorld) {}

#[when("alice authors a workload unit \"staging-api\" with:")]
async fn step_1607(_w: &mut TabaWorld) {}

#[then("alice authors a workload unit \"staging-api\" with:")]
...
#[when("alice authors a workload unit \"unsigned-api\" with:")]
async fn step_1610(_w: &mut TabaWorld) {}

#[then("alice authors a workload unit \"unsigned-api\" with:")]
...
#[when("alice authors a workload unit \"web-api\" with:")]
async fn step_1616(_w: &mut TabaWorld) {}

#[then("alice authors a workload unit \"web-api\" with:")]
...
#[when("alice does not sign the unit")]
async fn step_1649(_w: &mut TabaWorld) {}

#[then("alice does not sign the unit")]
...
#[given("alice signs the unit binding trust_domain \"acme-prod\" and cluster \"cluster-1\"")]
async fn step_1705(_w: &mut TabaWorld) {}

#[when("alice signs the unit binding trust_domain \"acme-prod\" and cluster \"cluster-1\"")]
async fn step_1706(_w: &mut TabaWorld) {}

#[then("alice signs the unit binding trust_domain \"acme-prod\" and cluster \"cluster-1\"")]
async fn step_1707(_w: &mut TabaWorld) {}

#[given(
    "alice signs the unit binding trust_domain \"acme-prod\" and cluster \"cluster-1\" with validity window 2026-01-01..2027-01-01"
)]
...
#[given(
    "alice signs the unit binding trust_domain \"acme-staging\" and cluster \"cluster-2\" with validity window 2026-01-01..2027-01-01"
)]
...
#[given(
    "alice signs the unit binding trust_domain \"wrong-domain\" and cluster \"cluster-1\" with validity window 2026-01-01..2027-01-01"
)]
...
#[given("an author \"alice\" with scope (type: workload, trust_domain: \"acme-prod\")")]
async fn step_1849(_w: &mut TabaWorld) {}

#[when("an author \"alice\" with scope (type: workload, trust_domain: \"acme-prod\")")]
async fn step_1850(_w: &mut TabaWorld) {}

#[then("an author \"alice\" with scope (type: workload, trust_domain: \"acme-prod\")")]
async fn step_1851(_w: &mut TabaWorld) {}

#[given("an author \"bob\" with scope (type: data, trust_domain: \"acme-prod\")")]
async fn step_1852(_w: &mut TabaWorld) {}

#[when("an author \"bob\" with scope (type: data, trust_domain: \"acme-prod\")")]
async fn step_1853(_w: &mut TabaWorld) {}

#[then("an author \"bob\" with scope (type: data, trust_domain: \"acme-prod\")")]
async fn step_1854(_w: &mut TabaWorld) {}

#[given("an author \"carol\" with scope (type: policy, trust_domain: \"acme-prod\")")]
async fn step_1855(_w: &mut TabaWorld) {}

#[when("an author \"carol\" with scope (type: policy, trust_domain: \"acme-prod\")")]
async fn step_1856(_w: &mut TabaWorld) {}

#[then("an author \"carol\" with scope (type: policy, trust_domain: \"acme-prod\")")]
async fn step_1857(_w: &mut TabaWorld) {}

#[given("an author \"dan\" with scope (type: data-steward, trust_domain: \"acme-prod\")")]
async fn step_1858(_w: &mut TabaWorld) {}

#[when("an author \"dan\" with scope (type: data-steward, trust_domain: \"acme-prod\")")]
async fn step_1859(_w: &mut TabaWorld) {}

#[then("an author \"dan\" with scope (type: data-steward, trust_domain: \"acme-prod\")")]
...
#[when("author keys are Ed25519 and not revoked")]
async fn step_2009(_w: &mut TabaWorld) {}

#[then("author keys are Ed25519 and not revoked")]
...
#[given("the WAL contains a Merged(\"web-api\") entry")]
async fn step_3298(_w: &mut TabaWorld) {}

#[when("the WAL contains a Merged(\"web-api\") entry")]
async fn step_3299(_w: &mut TabaWorld) {}

#[then("the WAL contains a Merged(\"web-api\") entry")]
...
#[when("the policy is submitted for graph merge")]
async fn step_4115(_w: &mut TabaWorld) {}

#[then("the policy is submitted for graph merge")]
...
#[given(
    "the unit classification is positioned at level 4 in the lattice (public=1 < internal=2 < confidential=3 < PII=4)"
)]
...
#[then("the unit is submitted for graph merge")]
...
#[given("the unit state is \"Declared\"")]
async fn step_4864(_w: &mut TabaWorld) {}

#[when("the unit state is \"Declared\"")]
async fn step_4865(_w: &mut TabaWorld) {}

#[then("the unit state is \"Declared\"")]
